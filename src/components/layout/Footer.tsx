...
const navigation = {
  ...
  studyAbroad: [
    ...
    { name: 'Singapore', href: '/study-abroad/singapore' },
  ],
  services: [
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Image src="/img/logo.svg" alt="Company logo" width={150} height={50} className="h-12 w-auto" priority />
            <p className="text-sm leading-6 text-gray-300">
              Helping students achieve their dreams of global education since 1991.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-white">Study Abroad</h3>
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.studyAbroad.map((item) => (
                    <li key={item.name}>
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm font-semibold leading-6 text-white">Student Services</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} Sans Enterprise. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
